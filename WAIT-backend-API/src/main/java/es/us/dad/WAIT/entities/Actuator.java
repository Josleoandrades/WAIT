...
public class Actuator {
	...
	public Actuator(String name, Integer idDevice, Boolean removed) {
		super();
		this.name = name;
	...
	public Actuator(Integer idActuator, String name, Integer idDevice, Boolean removed) {
		super();
		this.name = name;
	...
	public String toString() {
		return "Actuator [name=" + name + ", idActuator=" + idActuator + ", idDevice=" + idDevice + ", removed=" + removed + "]";
	}
